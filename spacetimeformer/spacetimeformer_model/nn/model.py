...
class Spacetimeformer(nn.Module):
    def __init__(
        ...
        dropout_attn_matrix: float = 0.05,
        ...
        GlobalSelfAttn = self._attn_switch(
                        global_self_attn,
                        **attn_kwargs,
                    )
        GlobalCrossAttn = self._attn_switch(
                        global_cross_attn,
                        **attn_kwargs,
                    )
        LocalSelfAttn = self._attn_switch(
                        local_self_attn,
                        **attn_kwargs,
                    )
        LocalCrossAttn = self._attn_switch(
                        local_cross_attn,
                        **attn_kwargs,
                    )
